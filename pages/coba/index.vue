<template>
  ...
  <div>
    <div
      class="flex items-center justify-between w-full p-6 bg-gray-900 rounded-r xl:hidden"
    >
    ...
    <div
      id="Main"
      class="flex flex-col items-start justify-start w-full h-full transition duration-500 ease-in-out transform bg-gray-900 xl:rounded-r xl:translate-x-0 sm:w-64"
    >
      <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
      ...
      <div
        class="flex flex-col items-center justify-start w-full pb-5 pl-4 mt-6 space-y-3 border-b border-gray-600"
      >
        <button
      ...
      <div
        class="flex flex-col items-center justify-start w-full px-6 border-b border-gray-600"
      >
        <button
          onclick="showMenu1(true)"
          class="flex items-center justify-between w-full py-5 text-left text-white focus:outline-none focus:text-indigo-400 space-x-14"
        >
        ...
        <div
          id="menu1"
          class="flex flex-col items-start justify-start w-full pb-1 md:w-auto"
        >
          <button
            class="flex items-center justify-start w-full px-3 py-2 space-x-6 text-gray-400 rounded hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 md:w-52"
          >
            <svg
              class="fill-stroke"
              width="24"
      ...
      <div
        class="flex flex-col items-center justify-between w-full h-full px-6 pb-6 space-y-32"
      >
        <button
        ...
        <div class="flex flex-col items-start justify-start hidden pb-5">
          <button
            class="flex items-center justify-start px-3 py-2 space-x-6 text-gray-400 rounded hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 w-52"
          >
            <svg
              class="fill-stroke"
              width="24"
        ...
        <div class="flex items-center justify-between w-full">
          <div class="flex items-center justify-center space-x-2">
            ...
            <div class="flex flex-col items-start justify-start">
              <p class="text-sm leading-5 text-white cursor-pointer">
                Alexis Enache
              </p>
              <p class="text-xs leading-3 text-gray-300 cursor-pointer">
                alexis81@gmail.com
              </p>
            </div>
          </div>
